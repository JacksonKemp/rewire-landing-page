      ...
      <section className="features-section" id="features">
        ...
        <div className="features-grid redesigned">
          ...
          <div className="feature-card">
            <div className="feature-icon-bg">
              {/* Check SVG */}
              <svg width="36" height="36" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="18" cy="18" r="18" fill="#E0F7FA"/><path d="M12 18l4 4 8-8" stroke="#4ecdc4" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
            </div>
            <div className="feature-content">
